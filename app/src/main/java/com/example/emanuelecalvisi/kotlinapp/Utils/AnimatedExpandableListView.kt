...
class AnimatedExpandableListView : ExpandableListView {
    ...
    abstract class AnimatedExpandableListAdapter : BaseExpandableListAdapter() {
        ...
        override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, convertView: View, parent: ViewGroup): View {
            ...
            if (info.animating) {
                ...
                val dummyView = convertView as DummyView
    ...
    class ExpandAnimation (private val view: View, private val baseHeight: Int, endHeight: Int, private val groupInfo: GroupInfo) : Animation() {
